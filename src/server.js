...
app.get('/exchange_token', async (req, res) => {
  ...
  try {
    ...
    if (response.ok) {
      ...
      const athletePFP = data.athlete.profile || "https://d3nn82uaxijpm6.cloudfront.net/assets/avatar/athlete/large-800a7033cc92b2a5548399e26b1ef42414dd1a9cb13b99454222d38d58fd28ef.png";
